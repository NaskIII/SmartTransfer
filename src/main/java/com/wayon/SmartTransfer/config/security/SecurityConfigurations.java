...
public class SecurityConfigurations extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.authorizeRequests()
                ...
                .antMatchers(HttpMethod.GET, "/patrimony/**").hasAnyAuthority(ROLE_ADMINISTRATOR, ROLE_COMMON)
                .antMatchers(HttpMethod.POST, "/patrimony").hasAnyAuthority(ROLE_ADMINISTRATOR)
                .antMatchers(HttpMethod.PUT, "/patrimony/**").hasAnyAuthority(ROLE_ADMINISTRATOR)
